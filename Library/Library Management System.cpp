...
class Lib
{
   public:
       ...
       Lib()
       {
          ...
          void ClearConsoleToColors(int ForgC, int BackC);//to change background colour
...
void Lib::show(int i)
{
    ...
    ofstream writer("f1.txt" , ios::app);
     writer << bookname << endl;
    writer.close();
...
{
    int i;
    std::ifstream input("f1.txt"); ///< open input file
    if (!input.is_open())
    {
...
void Lib::ClearConsoleToColors(int ForgC, int BackC)
{
